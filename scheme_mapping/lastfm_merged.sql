...
SELECT 
	...
	artist.bio::json->'summary' as artist_biography
from lastfm_album_tracks as api
LEFT JOIN (
	select tr.name, tr.artist_name, json_agg(tr_tags.name) as tags
	from lastfm_track as tr, json_populate_recordset(null::tag_row, tr.tags::json) tr_tags
...
LEFT JOIN (
	...
	, json_populate_recordset(null::tag_row, ar.tags::json->'tag') ar_tags group by ar.name)
